...
misc_arg.add_argument('--load_path', type=str, default='CelebA_0704_102557')
...
misc_arg.add_argument('--test_image', type=str, default=None,
...
#misc_arg.add_argument('--z_vector', type=str, default=None, help='the z_vector json file for the decoder')
#misc_arg.add_argument('--generated_img', type=str, default='g.png', help='the images generated by the decoder')
